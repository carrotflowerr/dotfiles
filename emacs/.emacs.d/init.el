...
;; remember as start buf
;; (setopt initial-buffer-choice 'remember-notes)
;; (setopt initial-major-mode 'org-mode)
;; (setopt initial-scratch-message nil)
;; (load "~/.emacs.d/elpa/minimal-dashboard.el/minimal-dashboard.el")
;;  (setopt initial-buffer-choice 'minimal-dashboard)
;; (setq initial-buffer-choice 
;;       (lambda () 
;;         (let ((buf (remember-notes)))
...
;;  === misc things from better-defaults.el / minimal-emacs.d
(show-paren-mode 1)
...
;; default bind replaces upcase-word
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("df6dfd55673f40364b1970440f0b0cb8ba7149282cf415b81aaad2d98b0f0290"
     ...
     "185cee92770717feccfdf437576fc0e8d6d1eefd9e643bcf4e8906ebfc2109d9"
 ...
 '(warning-suppress-log-types
   '((files missing-lexbind-cookie "~/.emacs.d/.mc-lists.el")
     (files missing-lexbind-cookie
            "~/.emacs.d/elpa/multiple-cursors-20250210.1813/multiple-cursors-core.el"))))
 '(global-display-line-numbers-mode t)
 '(menu-bar-mode nil)
 '(scroll-bar-mode nil)
 '(tool-bar-mode nil)
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "fixed" :foundry "misc" :slant normal :weight medium :height 151 :width normal)))))
