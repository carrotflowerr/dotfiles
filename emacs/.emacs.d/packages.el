...
;; lol.
(load "/home/shell/.emacs.d/elpa/zimblo-find-char.el")
(global-set-key (kbd "M-m") 'zimblo-find-char)
(global-set-key (kbd "M-M") 'zimblo-find-char-backward)
